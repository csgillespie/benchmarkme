...
#' @export
bm_prog_fib_mc = function(runs=3, verbose=TRUE, cores=NULL) {
  a = 0; b = 0; phi = 1.6180339887498949; K = cores * runs;
...
#' @export
bm_prog_hilbert_mc = function(runs=3, verbose=TRUE, cores=NULL) {
  a = 3500; b = 0; K = cores * runs
  timings = data.frame(user = numeric(runs), system=0, elapsed=0, 
...
#' @rdname bm_prog_fib_mc
#' @export
bm_prog_gcd_mc = function(runs=3, verbose=TRUE, cores = NULL) {
  ans = 0; K = cores * runs
  timings = data.frame(user = numeric(runs), system=0, elapsed=0, 
...
#' @rdname bm_prog_fib_mc
#' @export
bm_prog_toeplitz_mc = function(runs=3, verbose=TRUE, cores = NULL) {
  K = cores * runs
  timings = data.frame(user = numeric(runs), system=0, elapsed=0, 
